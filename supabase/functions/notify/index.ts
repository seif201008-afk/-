  ...
  const r = await fetch(`${GEMINI}/v1beta/models/${encodeURIComponent(model)}:generateContent`, {
    ...
    body: JSON.stringify({
      contents: [{
        role: "user",
        parts: [
          { text: "دي رسالة صوتية ممكن تكون بأي لغة. اسمعها واكتب اللي اتقال كلام مكتوب بالعامية المصرية (لو كانت أصلًا بالعربي المصري، اكتبها زي ما هي من غير تعديل). ترجمة بمعنى الكلام مش حرفية كلمة كلمة. من غير أي تعليق أو مقدمة زي \"الترجمة هي\" أو ذكر اللغة الأصلية، النص بس. لو الصوت مش واضح أو مفيش كلام، اكتب [مفيش كلام واضح] بس." },
